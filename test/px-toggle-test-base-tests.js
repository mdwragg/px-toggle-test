...
function runBaseTests() {
  px_toggle_test_1 = document.getElementById('px_toggle_test_1');

  suite('Base Automation Tests for px-toggle-test', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-toggle-test fixture is created', function() {
      assert.isTrue(document.getElementById('px_toggle_test_1') !== null);
    });
